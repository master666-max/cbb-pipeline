...
## 反思计数
- 自最后反思以来 wrap-up 次数：4（2026-09-11 reflect R-011~013 后清零；①内核项目关单+工具链通用化+审计规划 ②豆包线十三轮收口+原作者分支接收+WO-AUDIT-豆包规划 ③F3基础设施族接单整合记账 ④F1实验族接手整合记账+E80振数口径冲突对账）
...
- [PT-014 跨区责任田接单整合记账流水线](patterns.md#pt-014) — **已验证 2 次** · 适用：跨区下发记账/整合工单（机械对账→处置留痕→映射稿分流→滞后披露（v2：含语义级滞后=叙事层/制图层互矛盾）→活页视图；F1/F3 双族验证）
