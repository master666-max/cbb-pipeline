...
- [PT-019 研究仓隔离接手镜像建线：三件套+两态哈希+同行并留](patterns.md#pt-019) — 已验证 1 次 · 适用：把研究线迁入多线共享仓（START-HERE/INDEX/哈希表三件套、快照+真源锚、根表只加本行撞行并留、GIT_CONFIG_GLOBAL 绕 SSH）
