...
- [P-016 验证工具自身的变更没有同级防线，「改尺子」更危险](pitfalls.md#p-016) — 1 次触发（v892 假全绿事故：四道防线全失守复盘）
