...
用法：
  py -X utf8 矛盾对生成.py pairs  [--store <workspace>/本体库] [--out pairs.jsonl]
...
DEFAULT_STORE = ROOT / "<workspace>/本体库"
DEFAULT_CANDS = ROOT / "<workspace>/工作区" / "candidates"
DEFAULT_NLI_DIR = ROOT / "<workspace>/工作区" / "评分" / "nli"
