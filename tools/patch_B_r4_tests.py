...
rep("cbb-store/test_cbb_store.py",
    """import os
import sys
import tempfile""",
    """import json
...
# ---- cbb-anchor：A7 ----
rep("cbb-anchor/test_cbb_anchor.py",
    """if __name__ == "__main__":
    unittest.main(verbosity=2)""",
    '''class TestAuditR4Fixes(unittest.TestCase):
    """R4 审计修复批反例（A7）。"""
...
# ---- cbb-coordinate：A8 ----
rep("cbb-coordinate/test_cbb_coordinate.py",
    """if __name__ == "__main__":
    unittest.main(verbosity=2)""",
    '''class TestAuditR4Fixes(unittest.TestCase):
    """R4 审计修复批反例（A8）。"""
...
# ---- cbb-extract：A9 ----
rep("cbb-extract/test_cbb_extract.py",
    """if __name__ == "__main__":
    unittest.main(verbosity=2)""",
    '''class TestAuditR4Fixes(unittest.TestCase):
    """R4 审计修复批反例（A9）。"""
...
rep("tools/test_ledger_chain.py",
    """if __name__ == "__main__":
    fails = 0""",
...
rep("tools/test_neo4j_export.py",
    """import json
import sys
import tempfile""",
    """import json
