# modules/m-loop/install.md（v3.6/K-007a 渲染产物，手改即违例——v2.x 原文保留于包 bodies）
...
## 本模块交付文件（3 个，已由 install 落盘）
- modules/m-loop/install.md
- modules/m-loop/template/knowledge/skills/task-start/SKILL.md
- modules/m-loop/template/knowledge/skills/wrap-up/SKILL.md
