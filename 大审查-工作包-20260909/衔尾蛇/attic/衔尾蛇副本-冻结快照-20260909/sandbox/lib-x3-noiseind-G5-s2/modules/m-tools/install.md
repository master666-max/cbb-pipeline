# modules/m-tools/install.md（v3.6/K-007a 渲染产物，手改即违例——v2.x 原文保留于包 bodies）
...
## 本模块交付文件（4 个，已由 install 落盘）
- modules/m-tools/install.md
- modules/m-tools/template/tools/eval_retrieval.txt
- modules/m-tools/template/tools/lint_library.txt
- modules/m-tools/template/tools/search_knowledge.txt
