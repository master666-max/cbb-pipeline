...
- **新产物**：`98-冷启动考古总报告.md`（面向阅读的叙事总报告：缘起/三幕时间线/工作区画像/账本地图/核心发现十条/质量体系/事故修复史八起/遗留与下一圈/复现命令；一切数字转引并带时点，与 99-MAP 权威终报分工）。红队报告本体不在产出目录（红队会话侧留档），结论以 99-MAP 终审块+errata-log 转录为准。
