# experimental-l8/council/install.md（v3.6/K-007a 渲染产物，手改即违例——v2.x 原文保留于包 bodies）
...
- experimental-l8/council/install.md
- experimental-l8/council/template/knowledge/skills/council-reflect/SKILL.md
