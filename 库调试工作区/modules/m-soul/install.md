# modules/m-soul/install.md（v3.6/K-007a 渲染产物，手改即违例——v2.x 原文保留于包 bodies）
...
- modules/m-soul/install.md
- modules/m-soul/template/soul/SOUL.md
- modules/m-soul/template/soul/USER.md
