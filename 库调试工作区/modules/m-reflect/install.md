# modules/m-reflect/install.md（v3.6/K-007a 渲染产物，手改即违例——v2.x 原文保留于包 bodies）
...
- modules/m-reflect/install.md
- modules/m-reflect/template/knowledge/reflections.md
- modules/m-reflect/template/knowledge/skills/reflect/SKILL.md
