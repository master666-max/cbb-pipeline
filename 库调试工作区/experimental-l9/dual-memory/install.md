# experimental-l9/dual-memory/install.md（v3.6/K-007a 渲染产物，手改即违例——v2.x 原文保留于包 bodies）
...
- experimental-l9/dual-memory/install.md
- experimental-l9/dual-memory/template/trajectory-header.md
