# experimental/vector-search/install.md（v3.6/K-007a 渲染产物，手改即违例——v2.x 原文保留于包 bodies）
...
- experimental/vector-search/exp_vector_search.txt
- experimental/vector-search/install.md
